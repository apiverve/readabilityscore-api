// Package readabilityscore provides a Go client for the Text Readability Score API.
//
// For more information, visit: https://apiverve.com/marketplace/readabilityscore?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Text Readability Score API.
//
// Parameters:
//   - text (required): string - The text to calculate the readability score of
type Request struct {
...
// ResponseData contains the data returned by the Text Readability Score API.
type ResponseData struct {
	TextCounts TextCountsData `json:"textCounts"`
	Readability ReadabilityData `json:"readability"`
	ReadabilityText ReadabilityTextData `json:"readabilityText"`
}

// TextCountsData represents the textCounts object.
type TextCountsData struct {
	SyllableCount int `json:"syllableCount"`
	LexiconCount int `json:"lexiconCount"`
	SentenceCount int `json:"sentenceCount"`
}

// ReadabilityData represents the readability object.
...
// ReadabilityTextData represents the readabilityText object.
type ReadabilityTextData struct {
	FleschReadingEase string `json:"fleschReadingEase"`
	DaleChallReadabilityScore string `json:"daleChallReadabilityScore"`
}
